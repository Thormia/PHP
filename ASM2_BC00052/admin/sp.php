...
<?php
    ...
    $sql = "select * from supportrequirement";
  ...
  <div class="container">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">Support-Requirement</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div>
        <table class="table">
            <thead>
              <tr>
                <td colspan="1"></td>
                <th scope="col" colspan="3" id="or">SUPPORT REQUIREMENT</th>
              </tr>
            </thead>
          </table>
    </div>
    <table class="table">
        ...
        <tr id="list">
            ...
            <td>
               <a href="modifysp.php?id=<?php echo $row['ID']; ?>">Change</a>
            </td>
        </tr>
        <?php
                }
