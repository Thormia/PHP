  ...
  <div class="container">
        ...
        <table class="table">
            ...
            <tbody>    
              <tr>
                <th></th>
                <th scope="row">
                    <form action="addproduct.php" method="post" onsubmit="return Checkf()" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" name="des" id="pricepr">
                        </div>
                        <div class="mb-3">
    ...
    <table class="table">
        ...
        <tr id="list">
            ...
            <td>
            <a href="modifyproduct.php?id=<?php echo $row['Name']; ?>"><button type="button" class="btn btn-link" onclick="infor()">Modify</button></a> |
            <a href="deleteproduct.php?id=<?php echo $row['Name']; ?>"><button type="button" class="btn btn-link">Delete</button></a> 
            </td>
        </tr>
        <?php
                }
